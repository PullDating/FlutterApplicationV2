...
//for images
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Profile(uuid: $uuid, name: $name, birthdate: $birthdate, bodyType: $bodyType, gender: $gender, height: $height, datingGoal: $datingGoal, biography: $biography, latitude: $latitude, longitude: $longitude, images: $images)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('datingGoal', datingGoal))
